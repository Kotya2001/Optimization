...
def get_data(json_path):
    ...
    upperBound, totalBudget, totalProjPerYear = data['Мксимальное количество площадок в регионе в год'], data[
        'Общий бюджет'], data['Огрничение на количество проектов в год']
